...
import com.willowtreeapps.namegame.util.ListRandomizer;
...
class ApplicationModule {
    ...
    @Provides@NonNull @Singleton
    public NameGameViewModelFactory providesViewModelFactory(NameGame nameGame) {
        return new NameGameViewModelFactory(nameGame);
    }
